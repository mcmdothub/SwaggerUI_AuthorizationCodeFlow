...
namespace SwaggerUI_AuthorizationCodeFlow.OpenApi
{
    public class ConfigureSwaggerGenOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        private OpenApiInfo CreateOpenApiInfo()
        {
            return new OpenApiInfo()
            {
                ...
                Version = "v1",
                Description = "SwaggerUI - AuthorizationCodeFlow",
                Contact = new OpenApiContact() { Name = "API", Url = new Uri("https://github.com/mcmdothub") },
